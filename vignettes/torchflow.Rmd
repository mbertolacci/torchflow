...
Coupling blocks can also use rational-quadratic spline transforms. ActNorm
blocks can be inserted as standalone layers:
...
`input_size = 1`. Spline coupling blocks use a single coupling internally, and
can be composed to build richer univariate flows.
